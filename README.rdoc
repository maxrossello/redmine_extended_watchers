...
The system behaviour for the watcher user will be similar to that of 'view assigned issues' permission, except that the whole project gets hidden if the issue is unwatched (unless other permissions are given).
