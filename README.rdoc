...
In plain Redmine even non member users could be added as watchers, but a notification won't be sent to them. This is very confusing.
...
Look on the master branch if you want to be able to add any user as a watcher, irrespective of the 'view own or assigned issues' permission.
