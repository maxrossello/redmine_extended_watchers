...
# tests against an issue in a public project

class WatcherTestExtendedWatchersPublicProject < ActiveSupport::TestCase
  ...
  def test_default_add_watcher_users_selection
    with_settings :plugin_redmine_extended_watchers => { 'policy' => 'default' } do
      ...
      assert @issue.addable_watcher_users.include? User.find(3)
